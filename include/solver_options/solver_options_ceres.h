...
{
    // These include are for general rectangular systems formed from the
    // normal equations A'A x = A'b. They are direct include and do not
    ...
    // Specialized include, specific to problems with a generalized
...
//
// So sparse direct include like SPARSE_NORMAL_CHOLESKY and
...
enum class trust_region_strategy_enum : int16_t
{
    ...
    // factorization based linear include, i.e., SPARSE_SCHUR,
...
public:
    ...
    // Base solver options
    solverslib::solver_options_ceres_builder& with_max_iterations(int val)
    {
        options_->set_max_num_iterations(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_function_tolerance(double val)
    {
        options_->set_function_tolerance(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_gradient_tolerance(double val)
    {
        options_->set_gradient_tolerance(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_parameter_tolerance(double val)
    {
        options_->set_parameter_tolerance(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_verbose(bool val = true)
    {
        options_->set_debug(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_log_file(const std::string& val)
    {
    ...
    // Core Ceres options
    solverslib::solver_options_ceres_builder& with_linear_solver_type(linear_solver_enum val)
    {
        options_->set_linear_solver_type(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_preconditioner_type(preconditioner_enum val)
    {
        options_->set_preconditioner_type(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_minimizer_type(minimizer_enum val)
    {
        options_->set_minimizer_type(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_trust_region_strategy_type(
    ...
    solverslib::solver_options_ceres_builder& with_num_threads(int val)
    {
        options_->set_num_threads(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_max_solver_time_in_seconds(double val)
    {
    ...
    solverslib::solver_options_ceres_builder& with_dogleg_type(dogleg_enum val)
    {
        options_->set_dogleg_type(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_line_search_direction_type(
    ...
    solverslib::solver_options_ceres_builder& with_line_search_type(line_search_enum val)
    {
        options_->set_line_search_type(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_nonlinear_conjugate_gradient_type(
    ...
    solverslib::solver_options_ceres_builder& with_line_search_interpolation_type(
    ...
    solverslib::solver_options_ceres_builder& with_numeric_diff_method(numeric_diff_method_enum val)
    {
        options_->set_numeric_diff_method(val);
        return *this;
    }

    solverslib::solver_options_ceres_builder& with_sparse_linear_algebra_library_type(
    ...
    solverslib::solver_options_ceres_builder& with_dense_linear_algebra_library_type(
    ...
    solverslib::solver_options_ceres_builder& with_linear_solver_ordering_type(
    ...
    solverslib::solver_options_ceres_builder& with_aad_jacobian(bool val = true)
    {
    ...
    std::shared_ptr<const solver_options_ceres> build() const { return options_; }
