...
inline const char* to_string(solver_status status)
{
    ...
    case solver_status::numerical_failure: return "numerical_failure";
    case solver_status::infeasible: return "infeasible";
    case solver_status::unsupported_capability: return "unsupported_capability";
    case solver_status::backend_unavailable: return "backend_unavailable";
    case solver_status::user_stopped: return "user_stopped";
    }
    return "unknown";
}
...
inline const char* to_string(algorithm value)
{
    ...
    case algorithm::levenberg_marquardt: return "levenberg_marquardt";
    case algorithm::gauss_newton: return "gauss_newton";
    case algorithm::bfgs: return "bfgs";
    case algorithm::lbfgs: return "lbfgs";
    case algorithm::pounders: return "pounders";
    case algorithm::interior_point: return "interior_point";
    case algorithm::newton_krylov: return "newton_krylov";
    }
    return "unknown";
}
...
inline const char* to_string(backend value)
{
    ...
    case backend::ipopt: return "ipopt";
    case backend::petsc_tao: return "petsc_tao";
    case backend::pounders: return "pounders";
    case backend::ceres: return "ceres";
    case backend::nlopt: return "nlopt";
    }
    return "unknown";
}
}  // namespace solverslib::api
