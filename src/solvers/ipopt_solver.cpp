...
public:
    ...
    bool eval_f(
        Ipopt::Index n, const Ipopt::Number* x, bool /*new_x*/, Ipopt::Number& obj_value) override
    {
    ...
    bool eval_grad_f(
        Ipopt::Index n, const Ipopt::Number* x, bool /*new_x*/, Ipopt::Number* grad_f) override
    {
    ...
    SOLVERS_UNUSED const solver_options_ipopt&               options)
{
    ...
    Ipopt::SmartPtr<Ipopt::TNLP> nlp = new solvers_tnlp(num_parameters_,
        objective_,
        gradient_,
        hessian_,
        lower_bounds_,
    ...
    app->Options()->SetStringValue(
        "hessian_approximation", use_exact_hessian ? "exact" : "limited-memory");
