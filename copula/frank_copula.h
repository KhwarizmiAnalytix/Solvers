...
namespace quarisma
{
class MATH_VISIBILITY frank_copula : public copula
{
public:
    /**
     * @brief Constructor
     ...
     */
    MATH_API explicit frank_copula(double theta);

    /**
     * @brief Virtual destructor
     */
    MATH_API ~frank_copula() override;

    /**
     * @brief Evaluate the Frank copula function
    ...
    /**
     * @brief Evaluate the Frank copula density function
     * @param u Vector of uniform variates in [0,1]
    ...
    /**
     * @brief Generate multiple random samples from the Frank copula using a uniform random number generator function
