...
namespace quarisma
{
class MATH_VISIBILITY galambos_copula : public copula
{
public:
    /**
     * @brief Constructor
     ...
     */
    MATH_API explicit galambos_copula(double theta);

    /**
     * @brief Virtual destructor
     */
    MATH_API ~galambos_copula() override;

    /**
     * @brief Evaluate the Galambos copula function
    ...
    /**
     * @brief Evaluate the Galambos copula density function
     * @param u Vector of uniform variates in [0,1]
    ...
    /**
     * @brief Generate multiple random samples from the Galambos copula using a uniform random number generator function
