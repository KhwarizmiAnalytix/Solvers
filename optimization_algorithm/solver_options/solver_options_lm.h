...
private:
    solver_options_lm() : solver_options(quarisma::solver_enum::LM) {};
...
{
public:
    solver_options_lm_builder() : options_(ptr_mutable<solver_options_lm>(new solver_options_lm()))
    {
    }

    // Base solver options
    quarisma::solver_options_lm_builder& with_max_iterations(int val)
    {
        options_->set_max_num_iterations(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_function_tolerance(double val)
    {
        options_->set_function_tolerance(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_gradient_tolerance(double val)
    {
        options_->set_gradient_tolerance(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_parameter_tolerance(double val)
    {
        options_->set_parameter_tolerance(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_verbose(bool val = true)
    {
    ...
    // LM-specific options
    quarisma::solver_options_lm_builder& with_accept_uphill_step(bool val = true)
    {
        options_->set_accept_uphill_step(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_use_geodesic(bool val = true)
    {
        options_->set_use_geodesic(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_alpha(double val)
    {
        options_->set_alpha(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_lambda(double val)
    {
        options_->set_lambda(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_nu(double val)
    {
        options_->set_nu(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_lambda_down_fac(double val)
    {
        options_->set_lambda_down_fac(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_lambda_up_fac(double val)
    {
        options_->set_lambda_up_fac(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_epsilon(double val)
    {
        options_->set_epsilon(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_bump(double val)
    {
        options_->set_bump(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_type(levenberg_marquardt_solver_enum val)
    {
        options_->set_type(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_log_file(const std::string& val)
    {
        options_->set_log_file(val);
        return *this;
    }

    quarisma::solver_options_lm_builder& with_aad_jacobian(bool val = true)
    {
    ...
    ptr_const<solver_options_lm> build() const { return options_; }

private:
    ptr_mutable<solver_options_lm> options_;
};
