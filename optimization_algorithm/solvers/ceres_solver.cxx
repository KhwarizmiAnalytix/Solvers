...
public:
        ...
        double const* const* parameters, double* residuals, double** jacobians) const override
    {
        ...
        auto cost_function_bump = [this, bump](vector<double> const& x, matrix<double>& dy_dx)
        {
...
#if DEBUG_AAD
            matrix<double> grad2(num_residuals_, num_parameters_);
...
bool ceres_solver::solve(
    QUARISMA_UNUSED std::vector<double>&        parameters,
    QUARISMA_UNUSED const solver_options_ceres& options)
{
#if QUARISMA_MODULE_ENABLE_QUARISMA_ceres
